...
public class ForegroundCheckedTextView extends AppCompatCheckedTextView
        implements ForegroundCompatView {

    private final ForegroundHelper mForegroundHelper = new ForegroundHelper(this);

    public ForegroundCheckedTextView(@NonNull Context context) {
        super(context);

        mForegroundHelper.init(context, null, 0, 0);
    }

    public ForegroundCheckedTextView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
