...
public class ForegroundMultiAutoCompleteTextView extends AppCompatMultiAutoCompleteTextView
    ...
    public ForegroundMultiAutoCompleteTextView(@NonNull Context context) {
        super(context);

        mForegroundHelper.init(context, null, 0, 0);
    }

    public ForegroundMultiAutoCompleteTextView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
