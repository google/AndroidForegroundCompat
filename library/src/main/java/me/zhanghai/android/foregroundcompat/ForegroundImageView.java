...
public class ForegroundImageView extends AppCompatImageView implements ForegroundCompatView {
    ...
    public ForegroundImageView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
