...
public abstract class ForegroundViewGroup extends ViewGroup implements ForegroundCompatView {

    private final ForegroundHelper mForegroundHelper = new ForegroundHelper(this);

    public ForegroundViewGroup(@NonNull Context context) {
        super(context);

        mForegroundHelper.init(context, null, 0, 0);
    }

    public ForegroundViewGroup(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
