...
public class ForegroundEditText extends AppCompatEditText implements ForegroundCompatView {

    private final ForegroundHelper mForegroundHelper = new ForegroundHelper(this);

    public ForegroundEditText(@NonNull Context context) {
        super(context);

        mForegroundHelper.init(context, null, 0, 0);
    }

    public ForegroundEditText(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
