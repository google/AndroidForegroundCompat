...
public abstract class ForegroundCompoundButton extends CompoundButton
        implements ForegroundCompatView {

    private final ForegroundHelper mForegroundHelper = new ForegroundHelper(this);

    public ForegroundCompoundButton(@NonNull Context context) {
        super(context);

        mForegroundHelper.init(context, null, 0, 0);
    }

    public ForegroundCompoundButton(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
