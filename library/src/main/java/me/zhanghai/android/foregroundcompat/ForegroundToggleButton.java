...
public class ForegroundToggleButton extends AppCompatToggleButton implements ForegroundCompatView {

    private final ForegroundHelper mForegroundHelper = new ForegroundHelper(this);

    public ForegroundToggleButton(@NonNull Context context) {
        super(context);

        mForegroundHelper.init(context, null, 0, 0);
    }

    public ForegroundToggleButton(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
