...
public class ForegroundTableRow extends TableRow implements ForegroundCompatView {

    private final ForegroundHelper mForegroundHelper = new ForegroundHelper(this);

    public ForegroundTableRow(@NonNull Context context) {
        super(context);

        mForegroundHelper.init(context, null, 0, 0);
    }

    public ForegroundTableRow(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
